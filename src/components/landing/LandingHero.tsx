  ...
  return (
    <header className="relative w-full h-screen">
      ...
      <div className="relative bg-[rgba(0,0,0,0.6)] h-screen flex flex-col items-center px-4">
        <div className="flex flex-col items-center absolute top-1/4 left-1/2 -translate-x-1/2 sm:top-[25%]">
          <img
            loading="lazy"
            ...
            alt="Focus App Logo"
          />
          <h1 className="text-base text-[rgba(253,252,247,1)] text-center mt-16 leading-relaxed sm:text-[2.5rem] sm:mt-6 sm:leading-normal">
            Focus is a choice.
            <br />
