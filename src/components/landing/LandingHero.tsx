      ...
      <div className="relative bg-[rgba(0,0,0,0.55)] h-screen flex flex-col items-center px-4">
        <div className="flex flex-col items-center absolute top-1/3 left-1/2 -translate-x-1/2">
          <img
            ...
            className="w-[450px] max-w-full aspect-[1.81] object-contain md:w-[350px] sm:w-[300px]"
            alt="Focus App Logo"
          />
          <h1 className="text-lg text-[rgba(253,252,247,1)] text-center mt-8 sm:text-base sm:mt-6">
            Focus is a choice.
            <br />
