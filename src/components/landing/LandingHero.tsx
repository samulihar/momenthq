  ...
  return (
    <header className="relative w-full h-screen">
      <img
        ...
        alt="Background"
      />
      <div className="relative bg-[rgba(0,0,0,0.55)] h-screen flex flex-col items-center px-4 pt-32">
        <div className="flex flex-col items-center translate-x-8">
          <img
            ...
            className="w-[400px] max-w-full aspect-[1.81] object-contain"
            alt="Focus App Logo"
          />
          <h1 className="text-lg text-[rgba(253,252,247,1)] text-center mt-6">
            Focus is a choice.
            <br />
